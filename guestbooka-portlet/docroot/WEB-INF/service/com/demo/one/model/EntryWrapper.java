...
public class EntryWrapper implements Entry, ModelWrapper<Entry> {
	...
	*/
	...
	@Override
	public int compareTo(com.demo.one.model.Entry entry) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.demo.one.model.Entry> toCacheModel() {
		return _entry.toCacheModel();
	}

	@Override
	public com.demo.one.model.Entry toEscapedModel() {
		return new EntryWrapper(_entry.toEscapedModel());
	}

	@Override
	public com.demo.one.model.Entry toUnescapedModel() {
