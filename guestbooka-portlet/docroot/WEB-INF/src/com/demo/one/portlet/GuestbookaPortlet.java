...
/**
 * Portlet implementation class GuestbookaPortlet
 */
public class GuestbookaPortlet extends MVCPortlet {
	...
	public void addEntry(ActionRequest request, ActionResponse response) throws PortalException, SystemException {
		...
		try {
			...
			response.setRenderParameter("mvcPath", "/html/guestbooktwo/edit_entry.jsp");
		}
