...
import com.demo.one.NoSuchEntryException;
import com.demo.one.model.Entry;
import com.demo.one.model.impl.EntryImpl;
import com.demo.one.model.impl.EntryModelImpl;
...
public class EntryPersistenceImpl extends BasePersistenceImpl<Entry>
	...
	@Override
	public Entry updateImpl(com.demo.one.model.Entry entry)
		throws SystemException {
		entry = toUnwrappedModel(entry);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.demo.one.model.Entry")));
