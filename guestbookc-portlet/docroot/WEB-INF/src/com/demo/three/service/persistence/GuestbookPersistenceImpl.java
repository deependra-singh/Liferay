...
import com.demo.three.NoSuchGuestbookException;
import com.demo.three.model.Guestbook;
import com.demo.three.model.impl.GuestbookImpl;
import com.demo.three.model.impl.GuestbookModelImpl;
...
public class GuestbookPersistenceImpl extends BasePersistenceImpl<Guestbook>
	...
	@Override
	public Guestbook updateImpl(com.demo.three.model.Guestbook guestbook)
		throws SystemException {
		guestbook = toUnwrappedModel(guestbook);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.demo.three.model.Guestbook")));
	...
	private static final String _FILTER_SQL_SELECT_GUESTBOOK_WHERE = "SELECT DISTINCT {guestbook.*} FROM GBC_Guestbook guestbook WHERE ";
	private static final String _FILTER_SQL_SELECT_GUESTBOOK_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {GBC_Guestbook.*} FROM (SELECT DISTINCT guestbook.guestbookId FROM GBC_Guestbook guestbook WHERE ";
	private static final String _FILTER_SQL_SELECT_GUESTBOOK_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN GBC_Guestbook ON TEMP_TABLE.guestbookId = GBC_Guestbook.guestbookId";
	private static final String _FILTER_SQL_COUNT_GUESTBOOK_WHERE = "SELECT COUNT(DISTINCT guestbook.guestbookId) AS COUNT_VALUE FROM GBC_Guestbook guestbook WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "guestbook";
	private static final String _FILTER_ENTITY_TABLE = "GBC_Guestbook";
	private static final String _ORDER_BY_ENTITY_ALIAS = "guestbook.";
	private static final String _ORDER_BY_ENTITY_TABLE = "GBC_Guestbook.";
