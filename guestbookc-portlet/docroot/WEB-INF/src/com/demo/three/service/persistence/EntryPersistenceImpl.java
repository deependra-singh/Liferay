...
import com.demo.three.NoSuchEntryException;
import com.demo.three.model.Entry;
import com.demo.three.model.impl.EntryImpl;
import com.demo.three.model.impl.EntryModelImpl;
...
public class EntryPersistenceImpl extends BasePersistenceImpl<Entry>
	...
	@Override
	public Entry updateImpl(com.demo.three.model.Entry entry)
		throws SystemException {
		entry = toUnwrappedModel(entry);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.demo.three.model.Entry")));
	...
	private static final String _FILTER_SQL_SELECT_ENTRY_WHERE = "SELECT DISTINCT {entry.*} FROM GBC_Entry entry WHERE ";
	private static final String _FILTER_SQL_SELECT_ENTRY_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {GBC_Entry.*} FROM (SELECT DISTINCT entry.entryId FROM GBC_Entry entry WHERE ";
	private static final String _FILTER_SQL_SELECT_ENTRY_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN GBC_Entry ON TEMP_TABLE.entryId = GBC_Entry.entryId";
	private static final String _FILTER_SQL_COUNT_ENTRY_WHERE = "SELECT COUNT(DISTINCT entry.entryId) AS COUNT_VALUE FROM GBC_Entry entry WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "entry";
	private static final String _FILTER_ENTITY_TABLE = "GBC_Entry";
	private static final String _ORDER_BY_ENTITY_ALIAS = "entry.";
	private static final String _ORDER_BY_ENTITY_TABLE = "GBC_Entry.";
