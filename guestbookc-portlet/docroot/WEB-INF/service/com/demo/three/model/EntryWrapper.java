...
public class EntryWrapper implements Entry, ModelWrapper<Entry> {
	...
	*/
	...
	@Override
	public int compareTo(com.demo.three.model.Entry entry) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.demo.three.model.Entry> toCacheModel() {
		return _entry.toCacheModel();
	}

	@Override
	public com.demo.three.model.Entry toEscapedModel() {
		return new EntryWrapper(_entry.toEscapedModel());
	}

	@Override
	public com.demo.three.model.Entry toUnescapedModel() {
