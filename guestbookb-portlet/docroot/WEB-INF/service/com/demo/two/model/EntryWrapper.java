...
public class EntryWrapper implements Entry, ModelWrapper<Entry> {
	...
	*/
	...
	@Override
	public int compareTo(com.demo.two.model.Entry entry) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.demo.two.model.Entry> toCacheModel() {
		return _entry.toCacheModel();
	}

	@Override
	public com.demo.two.model.Entry toEscapedModel() {
		return new EntryWrapper(_entry.toEscapedModel());
	}

	@Override
	public com.demo.two.model.Entry toUnescapedModel() {
