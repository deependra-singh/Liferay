...
/**
 * The base model interface for the Guestbook service. Represents a row in the &quot;GBB_Guestbook&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.demo.two.model.impl.GuestbookModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.demo.two.model.impl.GuestbookImpl}.
 * </p>
 *
 * @author deependras
 * @see Guestbook
...
public interface GuestbookModel extends BaseModel<Guestbook>, StagedGroupedModel {
	...
	@Override
	public CacheModel<com.demo.two.model.Guestbook> toCacheModel();
