...
public class GuestbookWrapper implements Guestbook, ModelWrapper<Guestbook> {
	...
	*/
	...
	@Override
	public int compareTo(com.demo.two.model.Guestbook guestbook) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.demo.two.model.Guestbook> toCacheModel() {
		return _guestbook.toCacheModel();
	}

	@Override
	public com.demo.two.model.Guestbook toEscapedModel() {
		return new GuestbookWrapper(_guestbook.toEscapedModel());
	}

	@Override
	public com.demo.two.model.Guestbook toUnescapedModel() {
