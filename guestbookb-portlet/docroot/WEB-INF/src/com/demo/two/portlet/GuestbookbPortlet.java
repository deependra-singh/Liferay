...
/**
 * Portlet implementation class GuestbookbPortlet
 */
public class GuestbookbPortlet extends MVCPortlet {
	...
	public void addGuestbook(ActionRequest request, ActionResponse response) throws PortalException, SystemException {
		...
		try {
			...
			response.setRenderParameter("mvcPath", "/html/guestbooktwo/edit_guestbook.jsp");
		}
