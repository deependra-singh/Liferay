...
import com.demo.two.NoSuchGuestbookException;
import com.demo.two.model.Guestbook;
import com.demo.two.model.impl.GuestbookImpl;
import com.demo.two.model.impl.GuestbookModelImpl;
...
public class GuestbookPersistenceImpl extends BasePersistenceImpl<Guestbook>
	...
	@Override
	public Guestbook updateImpl(com.demo.two.model.Guestbook guestbook)
		throws SystemException {
		guestbook = toUnwrappedModel(guestbook);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.demo.two.model.Guestbook")));
	...
	private static final String _FILTER_SQL_SELECT_GUESTBOOK_WHERE = "SELECT DISTINCT {guestbook.*} FROM GBB_Guestbook guestbook WHERE ";
	private static final String _FILTER_SQL_SELECT_GUESTBOOK_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {GBB_Guestbook.*} FROM (SELECT DISTINCT guestbook.guestbookId FROM GBB_Guestbook guestbook WHERE ";
	private static final String _FILTER_SQL_SELECT_GUESTBOOK_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN GBB_Guestbook ON TEMP_TABLE.guestbookId = GBB_Guestbook.guestbookId";
	private static final String _FILTER_SQL_COUNT_GUESTBOOK_WHERE = "SELECT COUNT(DISTINCT guestbook.guestbookId) AS COUNT_VALUE FROM GBB_Guestbook guestbook WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "guestbook";
	private static final String _FILTER_ENTITY_TABLE = "GBB_Guestbook";
	private static final String _ORDER_BY_ENTITY_ALIAS = "guestbook.";
	private static final String _ORDER_BY_ENTITY_TABLE = "GBB_Guestbook.";
